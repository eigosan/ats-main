                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('resume.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="container">
                            ...
                            <h3 class="font-semibold text-lg text-gray-800 mt-4">Personal Information</h3>
                            <div class="row mb-2">
                                <div class="col">
                            ...
                            <button type="button" id="add-education" class="mt-4 inline-flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700">
                                Add Education
                            </button>
                            ...
                            <button type="button" id="add-work-experience" class="mt-4 inline-flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700">
                                Add Work Experience
                            </button>
                            ...
                            <div class="mt-1">
                                ...
                                <textarea name="skills" id="skills"
                                    class="mt-1 p-1 form-control rounded border-none shadow-sm text-sm" type="text"
                                    rows="5" style="overflow:hidden; resize:none;" placeholder="(Optional)"></textarea>
                            </div>
