                            ...
                            <div id="education-container">
                                <div class="education-item mb-2">
                                        ...
                                        <div class="col mt-1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control mt-1 p-1 w-full text-sm"
                                                    ...
                                                    <option value="some_college_university">Some College/University
                                                    </option>
                                            ...
                                            <div class="form-group mt-1" id="other_education_group"
                                                ...
                                                <x-text-input type="text"
                                                    class="form-control mt-1 p-1 w-full text-sm" id="other_education"
                                                    name="other_education" placeholder="Enter your education level" />
                                            </div>
                                        </div>
                                    ...
                                    <div class="mt-1">
                                        ...
                                        <x-text-input class="mt-1 p-1 w-full text-sm" type="text" name="institution"
                                            required />
                                    </div>
                                ...
                                <div class="work-experience-item mb-2">
                                    ...
                                    <div class="mt-1">
                                        ...
                                        <textarea name="job_description" id="skills" class="mt-1 p-1 form-control rounded border-none shadow-sm text-sm"
                                            type="text" rows="5" style="overflow:hidden; resize:none;"></textarea>
                                    </div>
                                    {{-- <button type="button"
